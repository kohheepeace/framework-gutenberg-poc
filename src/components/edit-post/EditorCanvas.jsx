/**
 * https://github.com/WordPress/gutenberg/blob/trunk/packages/editor/src/components/editor-canvas/index.js#L75
 */
...
function EditorCanvas({
  ...
  const {
    ...
    const { getPostType, canUser, getEditedEntityRecord } = select(coreStore);
    ...
    const template = currentTemplateId
      ? getEditedEntityRecord('postType', 'wp_template', currentTemplateId)
      : undefined;
